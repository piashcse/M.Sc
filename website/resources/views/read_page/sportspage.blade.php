    ...
    <div class="sp00"> <!--content main middle -->
                           ...
                           @foreach ($data00 as $udata)  
                                  ...
                                  <div class="ani_left">
													...
													<div class="banner"> <a  href="{{ URL::to('link_data_sports/' .  $udata->id) }}"><div class="img_lef00"><img src="{{ URL::to('/images/'.$udata->img) }}" alt="Smiley face" width="300" height="142" align="left"></div><h3><p style="color:black;">{{$udata->title}}</p> </h3>
                         				...
                         				<!--list view by table row -->
												...
												<table rules="rows" style=" margin:10px; padding:10px">
												  @foreach ($data4 as $udata)
														<tr>
															<td><a href="{{ URL::to('link_data_sports/' .  $udata->id) }}"> <div class="img_lef2"><img src="{{ URL::to('/images/'.$udata->img) }}"  width="40px" height="40px" align="left"></a>
															</div> </td>
															<td><a href="{{ URL::to('link_data_sports/' .  $udata->id) }}"> <p style="color:black;">{{$udata->name}}</p></a> </td>
														</tr>
												 @endforeach		 
												</table>
