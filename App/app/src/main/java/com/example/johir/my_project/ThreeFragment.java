   ...
   private ArrayList<Data> movieList = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view=inflater.inflate(R.layout.fragment_three, container, false);
        ...
        recyclerView = (RecyclerView) view.findViewById(R.id.recycler_view_three);
        ...
        mAdapter.setListener(new MoviesAdapter.Listener() {
            ...
            public void onClick(int position) {
              ...
              //  Toast.makeText(getActivity(), data.getTitle()+"/nid:"+data.getId() + " is selected!", Toast.LENGTH_SHORT).show();
                ...
                bundle.putString("VENUE_id", data.getId());
                bundle.putString("VENUE_tb", data.getTb());   //pass data to another class
    ...
    public void data22(){
       ...
       // String url = "http://192.168.0.106:82/data3/n3.php?page="+page;  //this for raw php code api

        Ur ur=new  Ur();
        String url2=ur.Murl+"/admin/sp/"+page;   //this is come from laravel api blog2
