...
public class TwoFragment extends Fragment {
   ...
   //  String url = "http:// 192.168.0.27:82/data3/n2.php?page="+page;  //this for raw php code api

        Ur ur=new  Ur();
        String url2=ur.Murl+"/admin/in/"+page;  //this is come from laravel api blog2
